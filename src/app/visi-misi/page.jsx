      ...
      <div className="container">
        ...
        <div className="bg-[#A1E3F937] rounded-lg p-10 mt-5">
          ...
          <ol className="list-decimal list-outside ml-6 space-y-4 text-justify text-sm leading-relaxed text-gray-800">
            <li>
              Meningkatkan pelaksanaan fungsi Kejaksaan RI dalam pelaksanaan
              tugas dan wewenang, baik dalam segi kualitas dan kuantitas
              penanganan perkara seluruh tindak pidana, penanganan perkara
              Perdata dan Tata Usaha Negara, serta meningkatkan kegiatan
              Intelijen penegakan hukum secara modern, berintegritas,
              profesional dan akuntabel yang berlandaskan keadilan, kebenaran
              serta nilai-nilai kepatutan dalam rangka penegakan hukum;
            </li>
            <li>
              Mewujudkan peran Kejaksaan RI dalam hubungan Internasional,
              kerjasama hukum, dan penyelesaian perkara lintas negara;
            </li>
            <li>
              Mewujudkan aparatur Kejaksaan RI yang modern, berintegritas,
            ...
            <li>
              ...
              masyarakat, penyusunan cetak biru (blue-print) pembangunan
              aparatur Kejaksaan RI jangka menengah dan jangka panjang tahun
              2025, menertibkan dan menata kembali manajemen keuangan, dan
          ...
          <p className="text-justify text-sm mt-6 leading-relaxed text-gray-800">
            Meningkatkan Reformasi Birokrasi dan Tata Kelola Kejaksaan RI yang
